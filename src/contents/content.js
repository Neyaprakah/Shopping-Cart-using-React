    ...
    return (
        <div>
            ...
            <div className="r7">
                ...
                <div className="r7r2">
                    <h4>Total Amount: {499 * state1.prod1 + 699 * state2.prod2 + 159 * state3.prod3 + 399 * state4.prod4 + 199 * state5.prod5}</h4>
                </div>
            </div>
        </div>
    );
